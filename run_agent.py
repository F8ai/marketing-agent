#!/usr/bin/env python3
"""
Standalone runner for Marketing Agent
...
async def main():
    parser = argparse.ArgumentParser(description='Run Marketing Agent')
    ...
    if args.interactive:
        ...
        print("💡 Try asking about: platform compliance, N8N workflows, creative strategies")
        while True:
            try:
                query = input("\nYou: ").strip()
                ...
                print(f"\n📢 Marketing Agent: {response['response']}")
